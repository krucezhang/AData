...
namespace AData.DataGenerator.Sources
{
    public class NameSource : DataSourceMatchName
    {
        ...
        private static readonly string[] _xing =
        {
        ...
        private static readonly string[] _mzi =
        {
            // Large cats
            "娟","洪","势","姐","杰","捷","元","缘","姚","歌","莎"
        };

        private static readonly string[] _lName =
        {
            // Large cats
            "娟","洪","势","姐","杰","捷","元","缘","姚","歌","莎"
        };
        ...
        {
            var a = _xing[RandomGenerator.Current.Next(0, _xing.Length)];
            var o = _mzi[RandomGenerator.Current.Next(0, _mzi.Length)];
            var l = _lName[RandomGenerator.Current.Next(0, _lName.Length)];
